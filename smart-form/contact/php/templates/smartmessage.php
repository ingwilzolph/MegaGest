                                            ...
                                            <table align="center">
                                               ...
                                               <td style="color:#666;padding:15px; padding-bottom:0;font-size:14px;line-height:20px;font-family:arial;text-align:left">
                                                    ...
                                                    <div style="font-style:normal;padding-bottom:15px;font-family:arial;line-height:20px;text-align:left">
                                                        ...
                                                        <p><span style="font-weight:bold;font-size:16px">Correo electronico:</span> '.$emailaddress.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Asunto del mensaje:</span> '.$sendersubject.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px;">Contenido del mensaje:</span> </p>
