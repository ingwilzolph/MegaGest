<?php
	...
	------------------------------------------------------ */
	$receiver_email = "administracion.alianzapro.cl";
	...
	----------------------------------------------------------------------------- */
	$poweredby_name = "AlianzaPro SPA";
	$poweredby_url = "https://alianzapro.cl/";	
